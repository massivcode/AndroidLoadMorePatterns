...
public class ScrollUpAndSwipeDownToLoadMoreItemsActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_scroll_up_and_swipe_down_to_load_more_items);
  ...
  private SwipeRefreshLayout.OnRefreshListener mOnSwipeRefreshListener = new OnRefreshListener() {
    @Override
    public void onRefresh() {
      mCurrentPage = 0;
      mIsReachedLastPages = false;
